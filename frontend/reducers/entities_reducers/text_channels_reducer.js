import { RECEIVE_TEXT_CHANNEL, REMOVE_TEXT_CHANNEL } from "../../actions/text_channel_actions";
...
const textChannelsReducer = (state = {}, action) => {
    ...
    switch (action.type) {
        ...
        case RECEIVE_SERVER: // Need this so that redirecting on creation of a server works
